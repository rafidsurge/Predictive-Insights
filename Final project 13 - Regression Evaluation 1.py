...
best_params = {
    'GradientBoostingRegressor': {'learning_rate': 0.1, 'max_depth': 5, 'n_estimators': 50},
    'RandomForestRegressor': {'max_depth': 6, 'n_estimators': 200},
    'AdaBoostRegressor': {'learning_rate': 0.2, 'n_estimators': 50},
    'XGBRegressor': {'learning_rate': 0.01, 'max_depth': 6, 'n_estimators': 200, 'colsample_bytree': 1.0, 'subsample': 0.9},
    'DecisionTreeRegressor': {'max_depth': 3, 'min_samples_leaf': 1, 'min_samples_split': 2}
}
