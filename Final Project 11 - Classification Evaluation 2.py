...
# Data Preprocessing
columns = [
    'kills', 'deaths', 'assists', 'earnedgold', 'earned gpm', 'earnedgoldshare', 'totalgold', 'golddiffat15',
    'opp_goldat15', 'goldspent', 'result'
]
...
best_params = {
    'KNN': {'metric': 'manhattan', 'n_neighbors': 10},
    'Decision Tree': {'criterion': 'entropy', 'max_depth': 6},
    'Logistic Regression': {'C': 10, 'solver': 'saga'},
    'Random Forest': {'criterion': 'entropy', 'n_estimators': 200},
    'Naive Bayes': {'var_smoothing': 1e-08},
    'Gradient Boosting': {'max_depth': 6, 'n_estimators': 200},
    'XGBoost': {'max_depth': 3, 'n_estimators': 200},
    'LightGBM': {'max_depth': 6, 'n_estimators': 200},
    'Bagging': {'max_features': 0.7, 'n_estimators': 200}
}
